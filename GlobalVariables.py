...
index=4 #Index where the Parameter List of the individual is, in the list: [ID,string[2],tradesheet,per_min_mtm,parameter_list,status] (lists index starts from 0)

#Note: BOTH PERFORMANCE MEASURES SHOULD BE SUCH THAT, GREATER THE BETTER (i.e. NetPL/DD, NetPL/Trades)
delta_Performance_Measure_1=5 #Delta for the first performance measure in the performance list
delta_Performance_Measure_2=10 #Delta for the second performance measure in the performance list
